...
ActiveRecord::Schema.define(version: 20170302151839) do
  ...
  create_table "user_songs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["songs_id"], name: "index_user_songs_on_songs_id", using: :btree
  ...
  add_foreign_key "user_songs", "songs", column: "songs_id"
